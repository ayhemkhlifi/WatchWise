    ...
    >
      ...
      <img src="/images/WatchWise_prev_ui.png" alt="logo" className="h-16 w-auto" />
        ...
        <ul className="flex flex-col items-center py-10 gap-10">
         ...
         { !user&&<Link to="/login" onClick={onClose} className=" flex gap-2 hover:bg-orange-500 p-2 rounded-xl">
            <User />
            <h1 className="text-white text-lg">Log-In</h1>
          </Link>}
          { user&&
            <Link to="/" onClick= {logout} className=" flex gap-2 hover:bg-orange-500 p-2 rounded-xl">
            <User />
